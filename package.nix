...
let
  pname = "t3code";
  version = "0.0.17";
  linuxHash = "sha256-uS+o1nRA3R7hn9BaomrdsGVC8UcpPFFRG3a1qGVrs8w=";
  darwinX64Hash = "sha256-wFR5BLR//KCZr5eyprvPdstM5zVO4Z0hcE0HkhIuOFA=";
  darwinArm64Hash = "sha256-mMOKjOKBnpNL83fWhbggg2lELneBSaaBUbOfGTIaD0A=";
