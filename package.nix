...
let
  pname = "t3code";
  version = "0.0.10";
  linuxHash = "sha256-zcPsaj4JyI8Ul7VZ4wsYvNH91GgKQZBgRADhgVu/zH8=";
  darwinX64Hash = "sha256-tMflnnTvCV/Rx6CFGwpDKFS44nsQn+H/Fl9Nx/M3Ve0=";
  darwinArm64Hash = "sha256-3VxTXxwl4dilqeeV6wE6jB7GdVQQe9sAoUlVx18+nxE=";
